...
public class Ques extends JFrame implements ActionListener{
    ...
    Ques(String name){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Icons/MCQ.png"));
        JLabel image = new JLabel(i1);
        image.setBounds(0,0,1480,200);
        add(image);
        
        qno = new JLabel();
        qno.setBounds(100,320,50,30);
        qno.setFont(new Font("Tohema",Font.PLAIN,24));
        add(qno);
        
        question = new JLabel();
        question.setBounds(150,320,900,30);
        question.setFont(new Font("Tohema",Font.PLAIN,24));
        add(question);
        ...
        opt1.setBounds(170,380,700,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton("Option 1");
        opt2.setBounds(170,420,700,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        public void paint(Graphics g){
            ...
            if (timer > 0){
                g.drawString(time, 1110, 370);
            }else{
                g.drawString("Times up !!",1100,370);
            }
            timer--;
